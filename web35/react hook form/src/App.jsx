...
const contactForm = z.object({
  infor: z.object({
    name: z
      ...
      .trim()
      .min(6, { message: "Tên phải có ít nhất 6 kí tự!" }),
    email: z.string().trim().email("Email không hợp lệ"),
    message: z.optional(z.string().trim().min(10, "Vui lòng nhập tin nhắn")),
  }),
});
                ...
                >
                  <VStack spacing={5}>
                    <FormControl>
                      ...
                      <ErrorMessage errors={errors} name="infor.name" />
                    </FormControl>
